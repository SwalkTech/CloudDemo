package com.swalktech.cloud.cloudproviderpayment8003.controller;


import com.swalktech.cloud.cloudcommon.entities.PayDTO;
import com.swalktech.cloud.cloudcommon.util.BeanCopyUtil;
import com.swalktech.cloud.cloudcommon.util.Result;

import com.swalktech.cloud.cloudproviderpayment8003.pojo.Pay;
import com.swalktech.cloud.cloudproviderpayment8003.service.PayService;
...
public class PayController {
    ...
    public String getInfoConsul(@Value("${swalktech.info}") String info){
        return "swalktech:info"+"   "+info+"   port:"+port;
    }
